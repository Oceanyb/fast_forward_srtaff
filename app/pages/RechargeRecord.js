...
export default class RechargeRecord extends Component<Props> {
  ...
  render() {
    return (
      <View style={{ height:"100%",backgroundColor:'#EFEFEF'}}>
        <XyNavBar bgc="#44A754" title="充值记录" left="back" nav={this.props.navigation} style={{ position: 'absolute', width: '100%', zIndex: 999 }} ></XyNavBar>
        <ScrollView
        ...
        >
          <View style={{marginTop:$xy.statusBarH + $xy.navH}}>
            <List style={{marginTop:6}}>
              ...
              >
                <Text style={{marginTop:8,marginLeft:12,fontSize:16}}>活动赠送</Text>
